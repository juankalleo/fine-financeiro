...
export function BottomNav() {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-2xl border-t border-white/[0.05] pb-safe-tight shadow-[0_-10px_30px_rgba(0,0,0,0.3)] touch-none">
      <nav className="flex items-center justify-around h-11 px-2">
