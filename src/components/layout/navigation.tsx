...
export function BottomNav() {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-2xl border-t border-white/[0.05] pb-safe shadow-[0_-10px_30px_rgba(0,0,0,0.3)]">
