...
export default function BillsPage() {
  ...
  return (
    <>
      ...
      >
        <div className="relative overflow-hidden bg-gradient-to-br from-apple-orange to-amber-500 rounded-b-[40px] px-6 pb-10 pt-[calc(env(safe-area-inset-top)+32px)] text-white shadow-2xl shadow-apple-orange/20">
          {/* Decorative Elements */}
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="text-right">
                <p className="text-[10px] font-black uppercase tracking-widest opacity-70">Contas</p>
