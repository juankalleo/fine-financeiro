...
export default function ReservesPage() {
  ...
  return (
    <>
      ...
      >
        <div className="relative overflow-hidden bg-gradient-to-br from-indigo-600 to-apple-blue rounded-b-[40px] px-6 pb-10 pt-[calc(env(safe-area-inset-top)+32px)] text-white shadow-2xl shadow-indigo-600/20">
          {/* Decorative Elements */}
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="text-right">
                <p className="text-[10px] font-black uppercase tracking-widest opacity-70">Reservas</p>
